define(["exports", "./validation-strategy", "../helper/class-helper"], function (exports, _validationStrategy, _helperClassHelper) {
    "use strict";
    ...
    var InlineStrategy = (function (_ValidationStrategy) {
        ...
        function InlineStrategy() {
            ...
            this.actionValidProperty = function (element, property) {
                _helperClassHelper.ClassHelper.removeClass(element, "invalid");
                _helperClassHelper.ClassHelper.addClass(element, "valid");
                _this._removeErrorElement(element);
            };

            this.actionInvalidProperty = function (element, property, error) {
                _helperClassHelper.ClassHelper.removeClass(element, "valid");
                _helperClassHelper.ClassHelper.addClass(element, "invalid");
