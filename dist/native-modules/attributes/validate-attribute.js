...
export var ValidateAttribute = (_dec = customAttribute('validate'), _dec2 = inject(Element, ViewTriggerRegistry, ViewStrategyRegistry), _dec(_class = _dec2(_class = (_class2 = function () {
